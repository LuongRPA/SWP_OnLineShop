    ...
    <body>
        ...
        <section id="menuContaniner">
            <ul class="main_nav">
                ...
                <li ><a  href="OrderList" style="color:green;">Manager Order</a></li>
            ...
            <div class="about" >
                ...
                <div class="search">
                    <form action="OrderList">
                        <input class="user" type="text"  maxlength="30" placeholder="Người mua..." value="${user_search}" name="user_search"/>
                    ...
                    <tbody>
                        <c:forEach items="${list}" var="x">
                            <tr>
                                <td>${x.username}</td>
                                <td>${x.productName}</td>
                                <td><a href="OrderDetail?orderId=${x.orderID}">Detail</a></td>
                            </tr>
                        </c:forEach>
                    </tbody>
                </table>
                ...
                <div class="page">
                    <p><c:forEach begin="1" end="${maxPage}" var="i">
                            <a href="OrderList?txtPage=${i}&user_search=${user_search}">${i}</a>
                        </c:forEach></p>
                </div>
            </div>
        </section>
