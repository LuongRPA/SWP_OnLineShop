    ...
    <body>
        ...
        <section id="menuContaniner">
            <ul class="main_nav">
                ...
                <% if (admin != null) {%>
                <li ><a  href="ListPostServlet" style="color:green;">Manager Post</a></li>
        ...
        <section id="mainContainer">
            ...
            <div class="about" >
                ...
                <%
                    if (admin != null) {
                %>
                <a class="btn btn-warning" href="FormAddPostServlet"> Thêm Post </a>
                <%
                    }
                %>
                ...
                <div class="products">
                    ...
                    <ul>
                        <li>
                            <div class="product">
                                ...
                                <div class="details">
                                    <h2> <%= p.getTitle()%></h2>
                                    <div class="price"> <%=p.getPublicAt()%> </div>
                                    <a href="PostDetailServlet?id=<%=p.getId()%>"> Chi tiết bài đăng </a>
                                    <%
                                        if (admin != null) {
                                    %>
                                    <a style="background-color: red" href="DeletePostServlet?id=<%=p.getId()%>"> Xóa bài </a>
                                    <%
                                        }
                                    %>
                                </div>
                    ...
                    <div class="page">
                        <p><c:forEach begin="1" end="${maxPage}" var="i">
                                <a href="ListPostServlet?txtPage=${i}&titleSearch=${titleSearch}">${i}</a>
                            </c:forEach></p>
                    </div>
                </div>
